...
export function createHud() {
  ...
  function showIdleTarget(item) {
    ...
    targetHint.innerHTML = 'Click or press <kbd>E</kbd> to pick up';
  ...
  function showHolding({ heldItem, aimedSlot, aimedTv }) {
    ...
    if (aimedTv) {
      targetHint.innerHTML = 'Click to play on the TV';
    } else if (aimedSlot) {
      targetHint.innerHTML = 'Click to place here · <kbd>E</kbd> to rent';
    } else {
      targetHint.innerHTML = '<kbd>E</kbd> rent · shelf to place · back-wall TV to play';
    }
    targetCard.hidden = false;
  ...
  function showDemoTv() {
    ...
    targetHint.innerHTML = 'Pick up a case, then click the TV to play';
    targetCard.hidden = false;
    hud.classList.add('has-target');
    hud.classList.remove('is-holding');
  }
