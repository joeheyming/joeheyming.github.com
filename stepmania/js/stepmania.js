...
colInfos.forEach(function (colInfo) {
    targets.push(Actor(imgDir+"down-target.png", { frameWidth: 64, frameHeight: 64, numFrames: 3 }, colInfo));
});
...
var judgment = Actor(imgDir + "judgment.png", { frameWidth: 168, frameHeight: 28, numFrames: 6 }, { x: 160, y: 160 })
