...
(function (a, b) {
  ...
  function bO(a, b, c, e) {
    if (d.isArray(b) && b.length)
      d.each(b, function (b, f) {
        c || bq.test(a)
          ? e(a, f)
          : bO(a + '[' + (typeof f === 'object' || d.isArray(f) ? b : '') + ']', f, c, e);
      });
  ...
  function bN(a, c, d, e, f, g) {
    ...
    for (; i < j && (k || !l); i++)
      (l = h[i](c, d, e)),
        typeof l === 'string' &&
          (!k || g[l] ? (l = b) : (c.dataTypes.unshift(l), (l = bN(a, c, d, e, l, g))));
          ...
          if (c) {
            ...
            if (d.nodeName(c, 'select')) {
              ...
              for (var k = i ? f : 0, l = i ? f + 1 : h.length; k < l; k++) {
                ...
                if (
                  m.selected &&
                  (d.support.optDisabled ? !m.disabled : m.getAttribute('disabled') === null) &&
                  (!m.parentNode.disabled || !d.nodeName(m.parentNode, 'optgroup'))
                ) {
                  a = d(m).val();
                  if (i) return a;
                  g.push(a);
    ...
    trigger: function (a, c, e) {
      ...
      if (!a.isPropagationStopped() && i) d.event.trigger(a, c, i, !0);
        ...
        if (
          ...
          try {
            l[m] &&
              ((k = l['on' + m]), k && (l['on' + m] = null), (d.event.triggered = !0), l[m]());
          } catch (q) {}
    ...
    (d.event.special.change = {
      filters: {
        ...
        click: function (a) {
          var b = a.target,
            c = b.type;
          (c === 'radio' || c === 'checkbox' || b.nodeName.toLowerCase() === 'select') &&
            B.call(this, a);
        },
        keydown: function (a) {
          var b = a.target,
      ...
      var k = function (b, d, e, g) {
        ...
        if (x.length > 1 && m.exec(b))
          ...
          !g &&
            ...
            ((q = k.find(x.shift(), d, w)), (d = q.expr ? k.filter(q.expr, q.set)[0] : q.set[0]));
          if (d) {
            (q = g
              ? { expr: x.pop(), set: p(g) }
              : k.find(
                  x.pop(),
                  x.length === 1 && (x[0] === '~' || x[0] === '+') && d.parentNode
                    ? d.parentNode
                    : d,
                  w
                )),
      ...
      html: function (a) {
        ...
        if (
          ...
          try {
            for (var c = 0, e = this.length; c < e; c++)
              this[c].nodeType === 1 &&
                (d.cleanData(this[c].getElementsByTagName('*')), (this[c].innerHTML = a));
          } catch (f) {
            this.empty().append(a);
          }
        }
          ...
          for (h = 0; g[h]; h++)
            ...
            (g[h].type && g[h].type.toLowerCase() !== 'text/javascript')
              ? (g[h].nodeType === 1 &&
                  g.splice.apply(
                    g,
                    [h + 1, 0].concat(d.makeArray(g[h].getElementsByTagName('script')))
                  ),
                e.appendChild(g[h]))
  ...
  (d.fn.css = function (a, c) {
    ...
    d.support.opacity ||
      (d.cssHooks.opacity = {
        get: function (a, b) {
          return bc.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || '')
    ...
    d.expr &&
      ...
      ((d.expr.filters.hidden = function (a) {
        ...
        return (
          (b === 0 && c === 0) ||
          (!d.support.reliableHiddenOffsets && (a.style.display || d.css(a, 'display')) === 'none')
        );
      }),
        ...
        e.ifModified &&
          ...
          (l.Accept =
            e.dataTypes[0] && e.accepts[e.dataTypes[0]]
              ? e.accepts[e.dataTypes[0]] + (e.dataTypes[0] !== '*' ? ', */*; q=0.01' : '')
              : e.accepts['*']);
    ...
    animate: function (a, b, c, e) {
      ...
      return this[f.queue === !1 ? 'each' : 'queue'](function () {
        ...
        for (c in a) {
          ...
          d.isArray(a[c]) &&
            (((b.specialEasing = b.specialEasing || {})[c] = a[c][1]), (a[c] = a[c][0]));
        }
          ...
          (c = j ? j.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === e &&
              ...
              d.offset.doesNotAddBorder &&
                (!d.offset.doesAddBorderForTableAndCells || !ce.test(b.nodeName)) &&
      ...
      (d.fn['inner' + c] = function () {
        ...
        (d.fn[e] = function (a) {
          ...
          if (d.isWindow(f)) {
            ...
            return (
              (f.document.compatMode === 'CSS1Compat' && g) || f.document.body['client' + c] || g
            );
          }
          if (f.nodeType === 9)
            return Math.max(
