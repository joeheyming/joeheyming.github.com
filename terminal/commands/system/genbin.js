...
function genbinHandler(terminal, args) {
  const flags = {
...
Examples:
  ...
  for (let i = 0; i < flags.count; i++) {
    ...
    output += `✅ ${fileName.padEnd(20)} ${sizeStr.padStart(8)} ${permissions} ${sizeInfo.desc}\n`;
  }
...
export default {
  name: 'genbin',
  handler: genbinHandler,
  description: 'generate binary files for testing',
  category: 'System'
};
