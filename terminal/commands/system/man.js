...
DESCRIPTION
  ...
  registerCommand(
    ...
    async (terminal, args) => {
      ...
      if (!window.commandRegistry.has(t)) {
        return {
          stdout: '',
      ...
      await window.commandRegistry.get(t);
      const cmds = window.commandRegistry.getCommands();
    ...
    'short manual pages for jsh commands (no real man-db)',
    'System'
  );
})();
