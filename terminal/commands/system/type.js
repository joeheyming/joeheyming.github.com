...
function describeCommand(terminal, cmdName, showAll) {
  ...
  const hasReg =
    ...
    typeof commandRegistry.has === 'function' &&
    commandRegistry.has(cmdName);
...
function typeHandler(terminal, args) {
...
export default {
  name: 'type',
  handler: typeHandler,
  description: 'display how a name would be interpreted as a command (-a, --help, --)',
  category: 'System'
};
