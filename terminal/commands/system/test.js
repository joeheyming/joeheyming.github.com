...
async function testCommandHandler(terminal, args) {
  return runTest(terminal, args, 'test');
}

async function bracketCommandHandler(terminal, args) {
  return runTest(terminal, args, '[');
}

const testDescription = 'evaluate a conditional expression (POSIX subset)';
