...
export class CommandRegistry {
  constructor() {
    ...
    this.commandMap = {
      ...
      free: 'commands/system/free.js',
      logger: 'commands/system/logger.js',
      dmesg: 'commands/system/dmesg.js',
      systemctl: 'commands/system/systemctl.js',
      journalctl: 'commands/system/journalctl.js',
      ...
      yes: 'commands/system/yes.js',
      cal: 'commands/system/cal.js',
      xargs: 'commands/system/xargs.js',
      printf: 'commands/system/printf.js',
      npm: 'commands/system/npm.js',
      npx: 'commands/system/npx.js',
      set: 'commands/system/set.js',
      jobs: 'commands/system/jobs.js',
      fg: 'commands/system/fg.js',
      bg: 'commands/system/bg.js',
      pstree: 'commands/system/pstree.js',
      ...
      tree: 'commands/filesystem/tree.js',
      rev: 'commands/filesystem/rev.js',
      ...
      tar: 'commands/filesystem/tar.js',
      gzip: 'commands/filesystem/gzip.js',
      gunzip: 'commands/filesystem/gunzip.js',
      du: 'commands/filesystem/du.js',

      // Fun commands
      sudo: 'commands/system/sudo.js',
      ...
      ddate: 'commands/fun/ddate.js',
      figlet: 'commands/fun/figlet.js',
      heyming: 'commands/fun/heyming.js',
