...
(function () {
  ...
  GamePad.prototype.getAxisState = function (rawPad, axisIndex) {
    var isPressed =
      rawPad['axes'][axisIndex] >= this._axisThreshold ||
      rawPad['axes'][axisIndex] <= -this._axisThreshold;
    var intState = isPressed ? 1 : 0;
  ...
  var Input = function (mainboard) {
    ...
    this._gamepadAxisMap = {
      UP: [
        { axis: gamepad_consts.leftStickVert, type: 'positive' },
        { axis: gamepad_consts.rightStickVert, type: 'positive' }
      ],
      DOWN: [
        { axis: gamepad_consts.leftStickVert, type: 'negative' },
        { axis: gamepad_consts.rightStickVert, type: 'negative' }
      ],
      LEFT: [
        { axis: gamepad_consts.leftStickHoriz, type: 'negative' },
        { axis: gamepad_consts.rightStickHoriz, type: 'negative' }
      ],
      RIGHT: [
        { axis: gamepad_consts.leftStickHoriz, type: 'positive' },
        { axis: gamepad_consts.rightStickHoriz, type: 'positive' }
      ],
