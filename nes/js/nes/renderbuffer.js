...
///////////////////////////////////////////////////////////////////////////////////////
// Removed g_ClearScreenArray to prevent memory leaks - using fill() instead
...
var renderbuffer = function (mainboard, renderSurface) {
  ...
  var paletteArray = [
    0x808080, 0xa63d00, 0xb01200, 0x960044, 0x5e00a1, 0x2800c7, 0x0006ba, 0x00178c, 0x002f5c,
    0x004510, 0x004a05, 0x2e4700, 0x664100, 0x000000, 0x050505, 0x050505, 0xc7c7c7, 0xff7700,
    0xff5521, 0xfa3782, 0xb52feb, 0x5029ff, 0x0022ff, 0x0032d6, 0x0062c4, 0x008035, 0x008f05,
    0x558a00, 0xcc9900, 0x212121, 0x090909, 0x090909, 0xffffff, 0xffd70f, 0xffa269, 0xff80d4,
    0xf345ff, 0x8b61ff, 0x3388ff, 0x129cff, 0x20bcfa, 0x0ee39f, 0x35f02b, 0xa4f00c, 0xfffb05,
    0x5e5e5e, 0x0d0d0d, 0x0d0d0d, 0xffffff, 0xfffca6, 0xffecb3, 0xebabda, 0xf9a8ff, 0xb3abff,
    0xb0d2ff, 0xa6efff, 0x9cf7ff, 0x95e8d7, 0xafeda6, 0xdaf2a2, 0xfcff99, 0xdddddd, 0x111111,
    0x111111, 0x000000
  ];
...
renderbuffer.prototype.clearBuffer = function () {
  // Use fill() instead of set() to avoid potential memory issues
