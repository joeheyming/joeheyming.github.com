...
ApuFrameCounter.prototype.getNextFrameClock = function (ticks) {
  ...
  var nextFrameTicks =
    this._lastFrameStartMtc + (this._sequenceStage + 1) * APU_FRAME_COUNTER_INTERVAL;
...
ApuFrameCounter.prototype.reset = function () {
  var that = this;
  this._irqEventId = this._mainboard.synchroniser.addEvent('apu irq', -1, function (eventTime) {
    that._eventApuIrq(eventTime);
  });
};
