...
(function () {
  ...
  cpu6502.prototype.handlePendingInterrupts = function () {
    ...
    if (this.resetPending) {
      for (var i = 0; i < 3; ++i) this.incrementStackReg(); // increment stack pointer but dont write to memory

      this.regStatus.Break = false;
      this.regStatus.Interrupt = true;

      if (this.cmosVersion) this.regStatus.Decimal = false;
  ...
  cpu6502.prototype.nonMaskableInterrupt = function (ppuMasterTickCount) {
    ...
    var hasCpuCaughtUp =
      this.mainboard.synchroniser.getCpuMTC() - COLOUR_ENCODING_MTC_PER_CPU <= ppuMasterTickCount; // g_nesMainboard->GetSynchroniser()->GetCpuMTC() - g_nesMainboard->GetModeConstants()->MasterCyclesPerCPU() <= ;
  ...
  cpu6502.prototype.read16FromMem = function (offsetAddress, lastCycle, iszeropage) {
    ...
    else newoffset = offsetAddress + 1;
  ...
  cpu6502.prototype.readInArgViaAddressingMode_DEBUG = function (
    instruction,
    instructionBytes,
    addressingModeArgs
  ) {
    ...
    switch (instruction.addressingmode) {
      ...
      case Nes.ADDRESSING_MODE.IMMEDIATE16: // Used only by JSR and JMP
        readInValue = this.read16FromMem(
          Nes.wrap16(this.programCounter + 1),
          instruction.functiontype === Nes.FUNCTION_TYPES.JMP,
          false
        );
  ...
  cpu6502.prototype.branchOperation = function (value, instruction) {
    ...
    if (this.branchTaken) {
      this.incrementSubCycle(false);
      if (value !== 0) {
        this.pageBoundaryCrossed =
          ((this.programCounter + 2) & 0xff00) !== ((value + this.programCounter + 2) & 0xff00);
      }
      if (this.pageBoundaryCrossed) this.incrementSubCycle(false);
      this.incrementSubCycle(true);
  ...
  cpu6502.prototype.executeOperation = function (value, instruction) {
    ...
    switch (instruction.opmode) {
      case Nes.OPERATION_MODE.NONE:
        return this.noneOperation(value, instruction);
      case Nes.OPERATION_MODE.ACCUMULATOR:
        return this.accumulatorOperation(value, instruction);
      case Nes.OPERATION_MODE.READ:
        return this.readOperation(value, instruction);
      case Nes.OPERATION_MODE.READ_MODIFY_WRITE:
        return this.rmwOperation(value, instruction);
      case Nes.OPERATION_MODE.WRITE:
        return this.writeOperation(value, instruction);
      case Nes.OPERATION_MODE.BRANCH:
        return this.branchOperation(value, instruction);
      case Nes.OPERATION_MODE.IMMEDIATE:
        return this.immediateOperation(value, instruction);
    }
    return null;
  };
  ...
  cpu6502.prototype.executeAction = function (value, instruction) {
    switch (instruction.functiontype) {
      case Nes.FUNCTION_TYPES.ADC:
        return this.actionADC(value, instruction);
      case Nes.FUNCTION_TYPES.AND:
        return this.actionAND(value, instruction);
      case Nes.FUNCTION_TYPES.ASL:
        return this.actionASL(value, instruction);
      case Nes.FUNCTION_TYPES.BCC:
        return this.actionBCC(value, instruction);
      case Nes.FUNCTION_TYPES.BCS:
        return this.actionBCS(value, instruction);
      case Nes.FUNCTION_TYPES.BEQ:
        return this.actionBEQ(value, instruction);
      case Nes.FUNCTION_TYPES.BIT:
        return this.actionBIT(value, instruction);
      case Nes.FUNCTION_TYPES.BMI:
        return this.actionBMI(value, instruction);
      case Nes.FUNCTION_TYPES.BNE:
        return this.actionBNE(value, instruction);
      case Nes.FUNCTION_TYPES.BPL:
        return this.actionBPL(value, instruction);
      case Nes.FUNCTION_TYPES.BRK:
        return this.actionBRK(value, instruction);
      case Nes.FUNCTION_TYPES.BVC:
        return this.actionBVC(value, instruction);
      case Nes.FUNCTION_TYPES.BVS:
        return this.actionBVS(value, instruction);
      case Nes.FUNCTION_TYPES.CLC:
        return this.actionCLC(value, instruction);
      case Nes.FUNCTION_TYPES.CLD:
        return this.actionCLD(value, instruction);
      case Nes.FUNCTION_TYPES.CLI:
        return this.actionCLI(value, instruction);
      case Nes.FUNCTION_TYPES.CLV:
        return this.actionCLV(value, instruction);
      case Nes.FUNCTION_TYPES.CMP:
        return this.actionCMP(value, instruction);
      case Nes.FUNCTION_TYPES.CPX:
        return this.actionCPX(value, instruction);
      case Nes.FUNCTION_TYPES.CPY:
        return this.actionCPY(value, instruction);
      case Nes.FUNCTION_TYPES.DEC:
        return this.actionDEC(value, instruction);
      case Nes.FUNCTION_TYPES.DEX:
        return this.actionDEX(value, instruction);
      case Nes.FUNCTION_TYPES.DEY:
        return this.actionDEY(value, instruction);
      case Nes.FUNCTION_TYPES.EOR:
        return this.actionEOR(value, instruction);
      case Nes.FUNCTION_TYPES.INC:
        return this.actionINC(value, instruction);
      case Nes.FUNCTION_TYPES.INX:
        return this.actionINX(value, instruction);
      case Nes.FUNCTION_TYPES.INY:
        return this.actionINY(value, instruction);
      case Nes.FUNCTION_TYPES.JMP:
        return this.actionJMP(value, instruction);
      case Nes.FUNCTION_TYPES.JSR:
        return this.actionJSR(value, instruction);
      case Nes.FUNCTION_TYPES.LDA:
        return this.actionLDA(value, instruction);
      case Nes.FUNCTION_TYPES.LDX:
        return this.actionLDX(value, instruction);
      case Nes.FUNCTION_TYPES.LDY:
        return this.actionLDY(value, instruction);
      case Nes.FUNCTION_TYPES.LSR:
        return this.actionLSR(value, instruction);
      case Nes.FUNCTION_TYPES.ORA:
        return this.actionORA(value, instruction);
      case Nes.FUNCTION_TYPES.PHA:
        return this.actionPHA(value, instruction);
      case Nes.FUNCTION_TYPES.PHP:
        return this.actionPHP(value, instruction);
      case Nes.FUNCTION_TYPES.PLA:
        return this.actionPLA(value, instruction);
      case Nes.FUNCTION_TYPES.PLP:
        return this.actionPLP(value, instruction);
      case Nes.FUNCTION_TYPES.ROL:
        return this.actionROL(value, instruction);
      case Nes.FUNCTION_TYPES.ROR:
        return this.actionROR(value, instruction);
      case Nes.FUNCTION_TYPES.RTI:
        return this.actionRTI(value, instruction);
      case Nes.FUNCTION_TYPES.RTS:
        return this.actionRTS(value, instruction);
      case Nes.FUNCTION_TYPES.SBC:
        return this.actionSBC(value, instruction);
      case Nes.FUNCTION_TYPES.SEC:
        return this.actionSEC(value, instruction);
      case Nes.FUNCTION_TYPES.SED:
        return this.actionSED(value, instruction);
      case Nes.FUNCTION_TYPES.SEI:
        return this.actionSEI(value, instruction);
      case Nes.FUNCTION_TYPES.STA:
        return this.actionSTA(value, instruction);
      case Nes.FUNCTION_TYPES.STX:
        return this.actionSTX(value, instruction);
      case Nes.FUNCTION_TYPES.STY:
        return this.actionSTY(value, instruction);
      case Nes.FUNCTION_TYPES.TAX:
        return this.actionTAX(value, instruction);
      case Nes.FUNCTION_TYPES.TAY:
        return this.actionTAY(value, instruction);
      case Nes.FUNCTION_TYPES.TSX:
        return this.actionTSX(value, instruction);
      case Nes.FUNCTION_TYPES.TXA:
        return this.actionTXA(value, instruction);
      case Nes.FUNCTION_TYPES.TXS:
        return this.actionTXS(value, instruction);
      case Nes.FUNCTION_TYPES.TYA:
        return this.actionTYA(value, instruction);

      // not legal
      case Nes.FUNCTION_TYPES.ASO:
        return this.actionASO(value, instruction);
      case Nes.FUNCTION_TYPES.RLA:
        return this.actionRLA(value, instruction);
      case Nes.FUNCTION_TYPES.LSE:
        return this.actionLSE(value, instruction);
      case Nes.FUNCTION_TYPES.RRA:
        return this.actionRRA(value, instruction);
      case Nes.FUNCTION_TYPES.AXS:
        return this.actionAXS(value, instruction);
      case Nes.FUNCTION_TYPES.LAX:
        return this.actionLAX(value, instruction);
      case Nes.FUNCTION_TYPES.DCM:
        return this.actionDCM(value, instruction);
      case Nes.FUNCTION_TYPES.INS:
        return this.actionINS(value, instruction);
      case Nes.FUNCTION_TYPES.ALR:
        return this.actionALR(value, instruction);
      case Nes.FUNCTION_TYPES.ARR:
        return this.actionARR(value, instruction);
      case Nes.FUNCTION_TYPES.XAA:
        return this.actionXAA(value, instruction);
      case Nes.FUNCTION_TYPES.OAL:
        return this.actionOAL(value, instruction);
      case Nes.FUNCTION_TYPES.SAX:
        return this.actionSAX(value, instruction);
      case Nes.FUNCTION_TYPES.NOP:
        return this.actionNOP(value, instruction);
      case Nes.FUNCTION_TYPES.SKB:
        return this.actionSKB(value, instruction);
      case Nes.FUNCTION_TYPES.SKW:
        return this.actionSKW(value, instruction);
      case Nes.FUNCTION_TYPES.HLT:
        return this.actionHLT(value, instruction);
      case Nes.FUNCTION_TYPES.TAS:
        return this.actionTAS(value, instruction);
      case Nes.FUNCTION_TYPES.SAY:
        return this.actionSAY(value, instruction);
      case Nes.FUNCTION_TYPES.XAS:
        return this.actionXAS(value, instruction);
      case Nes.FUNCTION_TYPES.AXA:
        return this.actionAXA(value, instruction);
      case Nes.FUNCTION_TYPES.ANC:
        return this.actionANC(value, instruction);
      case Nes.FUNCTION_TYPES.LAS:
        return this.actionLAS(value, instruction);
    }
  ...
  cpu6502.prototype.actionBRK = function (value) {
    ...
    this.regStatus.Interrupt = true;
    if (this.cmosVersion)
      // Decimal flag is cleared in the CMOS version
  ...
  cpu6502.prototype.actionINX = function (value) {
    this.incrementSubCycle(true);
    this.regX++;
    if (this.regX > 0xff) this.regX = 0;
    this.setSignAndZero(this.regX);
  };
  cpu6502.prototype.actionINY = function (value) {
    this.incrementSubCycle(true);
    this.regY++;
    if (this.regY > 0xff) this.regY = 0;
    this.setSignAndZero(this.regY);
  };
  ...
  cpu6502.prototype.actionDCM = function (value) {
    ...
    if (decremented < 0) decremented = 0xff;
  ...
  cpu6502.prototype.actionARR = function (value) {
    ...
    switch (this.regA & 0x60) {
      case 0x20:
        this.regStatus.Overflow = true;
        break;
      case 0x40:
        this.regStatus.Overflow = this.regStatus.Carry = true;
        break;
      case 0x60:
        this.regStatus.Carry = true;
        break;
...
flag.
  ...
  cpu6502.prototype.actionNOP = function (value, instruction) {
    this.incrementSubCycle(true);
  };
  ...
  cpu6502.prototype.actionXAS = function (value) {
    console.log('illegal instruction not implemented');
  };
  cpu6502.prototype.actionAXA = function (value) {
    console.log('illegal instruction not implemented');
  };
  ...
  cpu6502.prototype.actionLAS = function (value) {
    console.log('illegal instruction not implemented');
  };

  cpu6502.prototype.formatInstructionStatusString = function (
    programCounter,
    instruction,
    instructionBytesArray,
    addressingModeArgs
  ) {
    // program counter
    ...
    for (var i = 0; i < Math.max(instructionBytesArray.length, 3); ++i) {
      if (instructionBytesArray.length > i) str += Nes.ZERO_PAD_HEX(instructionBytesArray[i], 2);
      else str += '  ';
      str += ' ';
    }
    ...
    if (addressingModeArgs && addressingModeArgs.length > 0) {
      switch (instruction.addressingmode) {
        ...
        case Nes.ADDRESSING_MODE.ZEROPAGE:
          str +=
            '$' +
            Nes.ZERO_PAD_HEX(addressingModeArgs[0], 2) +
            ' = ' +
            Nes.ZERO_PAD_HEX(addressingModeArgs[1], 2);
          break;
        case Nes.ADDRESSING_MODE.ZEROPAGEX:
          str +=
            '$' +
        ...
        case Nes.ADDRESSING_MODE.ABSOLUTE:
          str +=
            '$' +
            Nes.ZERO_PAD_HEX(addressingModeArgs[0], 4) +
            ' = ' +
            Nes.ZERO_PAD_HEX(addressingModeArgs[1], 2);
          break;
        case Nes.ADDRESSING_MODE.ABSOLUTEX:
  ...
  cpu6502.prototype.saveState = function () {
    ...
    data.regStatus = Object.assign({}, this.regStatus);
    data.regS = this.regS;
    data.regX = this.regX;
    data.regY = this.regY;
    data.regA = this.regA;
  ...
  cpu6502.prototype.loadState = function (state) {
    ...
    this.regStatus = Object.assign({}, state.regStatus);
