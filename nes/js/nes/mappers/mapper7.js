...
mapper7.prototype.reset = function () {
  ...
  if (this.get8kChrBankCount() === 0) this.useVRAM();
  else this.switch8kChrBank(0);
...
mapper7.prototype.write8PrgRom = function (offset, data) {
  ...
  var mirroringMethod;
  if ((data & 0x10) > 0) mirroringMethod = PPU_MIRRORING_SINGLESCREEN_NT1;
  else mirroringMethod = PPU_MIRRORING_SINGLESCREEN_NT0;
