...
mapper15.prototype.write8PrgRom = function (offset, data) {
  ...
  var mirroringMethod;
  if ((data & 0x40) > 0) mirroringMethod = PPU_MIRRORING_HORIZONTAL;
  else mirroringMethod = PPU_MIRRORING_VERTICAL;
  ...
  switch (offset & 0x3) {
    case 2: // 8k mode ( 1 8k bank mirrored )
      for (var i = 0; i < 4; ++i) this.switch8kPrgBank(prgBank * 2 + (upper8k ? 1 : 0), i);
      break;
